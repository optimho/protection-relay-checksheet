...
Lighter-weight check sheets for routine in-service condition monitoring. Two files, one per relay family:

| File | Covers | Tabs |
|------|--------|------|
| `SEL_Biennial_Visual_Check.xlsx` | SEL-300G, SEL-311L, SEL-787, SEL-700G | 1 (generic SEL form) |
| `ABB_Biennial_Visual_Check.xlsx` | REG670 + RET670; REF/RET/REM/REU615 | 2 (670 tab + 615 tab) |
...
Generated by: `generate_SEL_biennial_check.py`, `generate_ABB_biennial_check.py`
